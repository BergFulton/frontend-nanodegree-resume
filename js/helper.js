...
var HTMLheaderRole = '<div class="dark-text highlight-text">%data%</div><hr>';
...
var HTMLworkEmployer = '<a class="employer-link" href="#">%data%';
...
var HTMLschoolMajor = '<em class= "major-em"><br>Major: %data%</em>';
